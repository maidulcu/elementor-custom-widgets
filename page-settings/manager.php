<?php
namespace DwlElementorAddon\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'unitek-elementor' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'unitek-elementor' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'unitek-elementor' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'unitek-elementor' ),
			]
		);
